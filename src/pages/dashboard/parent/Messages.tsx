...
const inbox = [
  { id: 1, from: "Mr. Daniel Marko", role: "Mathematics Teacher", subject: "David's performance update", time: "10 min ago", read: false, body: "Good day Mrs. Adeyemi. David has been showing great improvement in algebra this term. His test score of 88% is commendable. Please encourage him to continue with his revision schedule ahead of midterms." },
  { id: 2, from: "Admin", role: "School Administration", subject: "PTA Meeting — June 5", time: "2 hours ago", read: false, body: "Dear parent, we would like to invite you to our upcoming PTA meeting on Saturday June 5 at 10:00 AM. Refreshments will be provided. Kindly confirm your attendance." },
  { id: 3, from: "Mrs. Sarah James", role: "English Teacher", subject: "Grace's reading progress", time: "1 day ago", read: true, body: "Hello Mrs. Adeyemi, I wanted to share that Grace has been excelling in our reading comprehension sessions. She recently scored 92% in the English reading test. A gifted learner!" },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Communications from teachers and school admin.</p>
      </div>
